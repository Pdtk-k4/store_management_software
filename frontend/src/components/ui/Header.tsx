            ...
            <div className="flex items-center justify-between px-4 py-3 lg:px-6">
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        id="menu-toggle"
                        className="lg:hidden text-gray-600 hover:text-gray-800 border-0 bg-white"
                    >
                ...
                <div className="flex items-center space-x-3">
                    {/* Mobile Search */}
                    <button className="sm:hidden text-gray-600 hover:text-gray-800 border-0 bg-white">
                        <i className="fa-solid fa-magnifying-glass text-lg text-gray-700"></i>
                    </button>

                    {/* Notifications */}
                    <div className="relative">
                        <button className="relative p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors border-0 bg-white ">
                    ...
                    <div className="relative" ref={profileRef}>
                        ...
                        {/* Profile Dropdown */}
                        {isProfileOpen && (
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg border border-gray-300 shadow-md z-50">
                                <div className="py-2">
                                    <Link
                                        to="/profile"
                                    ...
                                    <hr className="my-2 border-t border-gray-200 opacity-30" />
                                    <Link
                                        to="/logout"
